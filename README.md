...
- [Vestige](https://github.com/samvallad33/vestige) - Local-first cognitive memory MCP server for coding agents, with SQLite storage, FSRS-style retention, hybrid retrieval, provenance/correction tools, and a dashboard.
