...
- <img src="https://samvallad33.github.io/vestige/favicon.svg" height="14"/> [Vestige](https://github.com/samvallad33/vestige) - Local-first cognitive memory for AI agents. FSRS-6 spaced-repetition decay, prediction-error gating, active forgetting, and a real-time 3D memory dashboard, all in one Rust binary. Your data stays on your machine.
