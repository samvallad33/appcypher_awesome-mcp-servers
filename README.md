...
- <img src="https://cdn.simpleicons.org/rust/DEA584" height="14"/> [Vestige](https://github.com/samvallad33/vestige) - Local-first persistent memory for AI agents. Stores cross-session context on the user's machine; works with any MCP client.
